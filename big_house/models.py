...
class Shipment(models.Model):
    ...
    express_code = models.CharField(db_column='EXPRESS_CODE', null=False, max_length=50)
    express_orders_no = models.CharField(db_column='EXPRESS_ORDERS_NO', null=False, max_length=100, unique=True)
    express_name = models.CHarField(db_column='EXPRESS_NAME', null=False, max_length=255)
    express_cost = models.DecimalField(db_column='EXPRESS_COST', null=False, max_digits=20,
                                       decimal_places=2, default=0.00)
    courier = models.CharField(db_column='COURIER', null=False, max_length=100)
    courier_tel = models.CharField(db_column='COURIER_TEL', null=False, max_length=32)
    create_time = models.DateTimeField(db_column='CREATE_TIME', null=False, auto_now_add=True)
    creator = models.CharField(db_column='CREATOR', null=False, max_length=50)
    update_time = models.DateTimeField(db_column='UPDATE_TIME', null=False, auto_now_add=True)
    updater = models.CharField(db_column='UPDATER', null=False, max_length=50)
