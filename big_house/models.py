...
class Goods(models.Model):
    ...
    goodsBulk = models.DecimalField(db_column='GOODS_BULK', max_digits=20, decimal_places=2, default=0.00)
    goodsWeight = models.DecimalField(db_column='GOODS_WEIGHT', max_digits=20, decimal_places=2, default=0.00)
